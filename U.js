...
export default class U extends React.Component {
  ...
  render() {
    ...
    return <A.Path d={`M${initialCoordinates} v${height * 0.9} a${height * 0.1875},${height * 0.1875} 0 0,0 ${height*0.375},0 v${-height * 0.9} a${height * 0.0625},${height * 0.0625} 0 0,0 -${height*0.125},0 v${height * 0.9} a${height * 0.0625},${height * 0.0625} 0 1,1 -${height*0.125},0 v${-height * 0.9} a${height * 0.0625},${height * 0.0625} 0 0,0 -${height*0.125},0`} fill={fill} stroke={stroke} strokeWidth={pathSwell} />
  }
}